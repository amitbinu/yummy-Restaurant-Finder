...
public class GeoCoder {
	...
	private static void restaurant_getter(String origin, String city, Stack<String> FOOD) throws Exception{
		...
		/*	GeocodingApi geocodingApi = null;
			GeocodingResult[] results = geocodingApi.geocode(context, address.results[i].formattedAddress).await();
			latitudes.push(results[0].geometry.location.lat);
			longitudes.push(results[0].geometry.location.lng); */
