...
public class Restaurant {
	...
	public Restaurant(String restaurant_name, String address, Double time, Double distance, Double rating, Bitmap samplePhotos, Boolean open, Boolean permanentlyClosed, String price){
